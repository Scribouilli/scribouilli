  ...
  return () =>
    Promise.resolve(login).then((login) =>
      json("https://api.github.com/user/repos", {
        ...
        .then(() => {
          return json(
            `https://api.github.com/repos/${login}/${repoName}/contents/index.md`,
            {
              headers: { Authorization: "token " + accessToken },
              method: "PUT",
              body: JSON.stringify({
        ...
        .then(() => {
          return json(
            `https://api.github.com/repos/${login}/${repoName}/contents/activites.md`,
            {
              headers: { Authorization: "token " + accessToken },
              method: "PUT",
              body: JSON.stringify({
        ...
        .then(() => {
          return json(
            `https://api.github.com/repos/${login}/${repoName}/contents/contact.md`,
            {
              headers: { Authorization: "token " + accessToken },
              method: "PUT",
              body: JSON.stringify({
        ...
        .then(() => {
          return json(
            `https://api.github.com/repos/${login}/${repoName}/contents/images/readme.md`,
            {
              headers: { Authorization: "token " + accessToken },
              method: "PUT",
              body: JSON.stringify({
        ...
        .then(() => {
          return json(
            `https://api.github.com/repos/${login}/${repoName}/contents/_posts/.gitkeep`,
            {
              headers: { Authorization: "token " + accessToken },
              method: "PUT",
              body: JSON.stringify({
        ...
        .then(() => {
          return databaseAPI.createCustomCSS(
            login,
            repoName,
