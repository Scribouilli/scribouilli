 ...
 */
// export const cloneTemplateRepositoryForCurrentAccount = async repoName => {
...
// publishedWebsiteURL: makeGithubPublishedWebsiteURL(login, repoName),
// publicRepositoryURL: makeGithubPublicRepositoryURL(login, repoName),
// })

// return gitAgent.clone(scribouilliGitRepo, repoTemplateGitUrl)
// }
...
export const createRepositoryForCurrentAccount = async repoName => {
  ...
  // return (
  // gitAgent
  // .clone(scribouilliGitRepo, repoTemplateGitUrl)
  // .then(() => {
